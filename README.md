...
En la imagen de la izquierda se puede apreciar que el modelo YOLOv10n antes del entrenamiento y ajuste fino, detecta objetos comunes. La imagen de la derecha muestra la evaluación del modelo entrenado, se puede observar que marca como malo una zona de la imágen, posiblemente por algún rasgo en el color y la sombra, sin embargo ya no detecta los otros objetos al rededor.
<p align="center">
